...
void InitAllVertexDeclarations(IDirect3DDevice9* pD3DDevice)
{
	...
	HR(pD3DDevice->CreateVertexDeclaration(VertexPosElements, &VertexPos::Decl));
	...
	HR(pD3DDevice->CreateVertexDeclaration(VertexColElements, &VertexCol::Decl));
	...
	HR(pD3DDevice->CreateVertexDeclaration(VertexPNElements, &VertexPN::Decl));
	...
	HR(pD3DDevice->CreateVertexDeclaration(GrassVertexElements, &GrassVertex::Decl));
}
